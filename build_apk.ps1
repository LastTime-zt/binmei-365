...
# 7. 签名（keystore 持久化, 保证签名一致; 此ks已随v5.5发布, 不可更换/重新生成）
...
# 输出到 AutoAnswerApp 目录（APK 统一放这里，不丢根目录）
Copy-Item "$root\AutoAnswer.apk" "$src\AutoAnswerApp\AutoAnswer.apk" -Force
