...
Copy-Item "d:\Code\android-逆向\彬煤安培365\question_bank.db" "$root\assets\question_bank.db" -Force
...
& javac -encoding UTF-8 -source 11 -target 11 -classpath $plat -d "$root\classes" $srcs
